<template>
    <v-container fluid>
      <v-card
        ...
        tile
        flat
        class="d-flex align-center justify-center" dark  >
        <v-row>
          <v-col cols="12" sm="12">
      ...
      <v-card tile class="mx-16 mt-n10 card1" color="black">
        <v-row>
          <v-col cols="12" sm="8" class="pr-0">
            <v-card height="250px" tile flat color="#eeeeee">
              <v-row>
                <v-col cols="12" sm="4" class="pl-8 pt-5">
                  <v-btn color="#000000" dark class="withoutupercase" small tile>
                    new
                  </v-btn>
                  <h6 class="black--text mt-8">MOUNTAIN BIKE</h6>
                  <h3 class="black--text mt-5">Trek Speed Concept</h3>
                  <v-btn rounded color="#000000" dark class="withoutupercase px-8 mt-10" >
                    More Info
                  </v-btn>
                </v-col>
                <v-col cols="12" sm="8">
            ...
            <v-card height="250px" tile flat color="#eeeeee">
              <v-row>
                <v-col cols="12" sm="6" class="pl-8 pt-5">
                  ...
                  <h6 class="black--text mt-8">DOWN JACKET</h6>
                  <h3 class="black--text mt-5">Sale Collection 2022</h3>
                  <v-btn rounded color="#000000" dark class="withoutupercase px-8 mt-3" >
                    More Info
                  </v-btn>
                </v-col>
                <v-col cols="12" sm="6">
          ...
          <v-col cols="12" sm="3" class="mt-n6 pr-0">
            <v-toolbar flat outlined>
              ...
              <v-btn icon class="ml-1">
                <v-icon color="#000000"> mdi-sync </v-icon>
              </v-btn>
            </v-toolbar>
          </v-col>
          ...
          <v-col cols="12" sm="3" class="mt-n6 pl-0">
            <v-toolbar flat outlined>
              <v-btn icon class="mr-1">
                <v-icon color="#eeeeee">mdi-apps</v-icon>
              </v-btn>
              <v-divider vertical></v-divider>
